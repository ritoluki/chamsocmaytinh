                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul id="multi" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                            <li class="sidebar-item">
                                <a href="chucnang/qlnv/index.php" class="sidebar-link ">
                        ...
                        <ul id="multi" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                            <li class="sidebar-item">
                                <a href="chucnang/qlkh/khachhang.php" class="sidebar-link ">
                        ...
                        <ul id="multi" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                            <li class="sidebar-item">
                                <a href="chucnang/qllk/linhkien.php" class="sidebar-link ">
                        ...
                        <ul id="multi" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                            <li class="sidebar-item">
                                <a href="chucnang/qldv/qldv.php" class="sidebar-link ">
                        ...
                        <ul id="multi" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                            <li class="sidebar-item">
                                <a href="chucnang/qlsddv/sddv.php" class="sidebar-link ">
                                    <i class="fa-solid fa-screwdriver-wrench"></i>
        ...
        <div class="main">
            <nav class="navbar navbar-expand px-3 border-bottom">
                ...
                <ul class="navbar-nav me-3">
                    <li class="nav-item">
                        <a href="#" class="nav-link click-printname">Trang chủ</a>
                    </li>
                </ul>
            ...
            <main class="content px-3 py-2">
                <div class="container-fluid">
                    ...
                    <div class="mb-3">
                        <?php include "chucnang/baocaothongke/baocaothongke.php" ?>
